      ...
      <>
        ...
        <main>
          ...
          <section id="project-content">
            ...
            <div className="spacer small"></div>
            <p>Calypso is the second project born out of the <a href="https://www.coursera.org/professional-certificates/google-ux-design?utm_source=google&utm_medium=institutions&utm_campaign=gwgsite&_ga=2.116649280.716155318.1630610849-91001625.1630610849" target="_blank" rel="noreferrer">Google UX Design Certificate Program</a>, the first one being <a href="./3sixty" target="_blank" rel="noreferrer">3sixty</a>.</p>
            ...
            <div className="spacer small"></div>
            <h2>Problem</h2>
            <p>Users visiting a yacht charter company want to book a vacation on a boat. However their needs can be quite different. I chose to focus on two groups of users:
              <ul>
            ...
            <p>I conducted a competitive audit on 2 direct competitors:
              <ul>
            ...
            <p>Some gaps I identified include:
              <ul>
            ...
            <p>Some opportunities I identified include:
              <ul>
            ...
            <p>From there, I flexed a bit my creative muscle with the How Might We? and the Crazy 8 ideation techniques.
              <ol>
            ...
            <h3>Sitemap</h3>
            <p>I chose a hierarchical website structure with very distinct sections corresponding to users' needs (search, learn, charter or own). Additional information can be found in the footer or second menu.
              <StaticImage
            ...
            <p>Click on the following screenshot to access the low-fidelity prototype:
            <a href="https://xd.adobe.com/view/89da4356-8a02-4514-8ee0-2f2368ea334c-dc89/" target="_blank" rel="noreferrer">
              <StaticImage
            ...
            <div className="spacer small"></div>
            <h2>Outcome</h2>
            <p>After a usability study conducted on the low-fidelity prototype and another one conducted on the high-fidelity prototype, improvements were brought to the initial design:
              <ul>
            ...
            <p>Click on the following screenshot to access the high-fidelity prototype:
            <a href="https://xd.adobe.com/view/62033fc7-bb8e-41a6-9bcf-794c014e2e1e-3750/" target="_blank" rel="noreferrer">
              <StaticImage
